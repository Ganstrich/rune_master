...
.matrix-row-synergy {
    background-color: rgba(16, 185, 129, 0.08) !important; /* Light green tint for shared */
}

/* Ensure synergy rows remain readable in dark mode */
@media (prefers-color-scheme: dark) {
    .matrix-row-synergy {
